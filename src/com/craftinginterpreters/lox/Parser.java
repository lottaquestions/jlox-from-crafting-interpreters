...
public class Parser {
    ...
    private int maxAllowableParams = 255;
    ...
    private Stmt.Function function(String kind){
        ...
        if (!check(RIGHT_PAREN)){
            do{
                if (parameters.size() > maxAllowableParams){
                    error(peek(), "Can't have more than" + maxAllowableParams +" parameters.");
                }
